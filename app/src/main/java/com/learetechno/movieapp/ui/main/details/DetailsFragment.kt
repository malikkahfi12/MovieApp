package com.learetechno.movieapp.ui.main.details
...
import com.learetechno.movieapp.util.Constants.Companion.BASE_URL_IMG
...
class DetailsFragment : Fragment(R.layout.fragment_details) {
    ...
    private fun showDataDetails(it: Details) {
        ...
        if (it.releaseDate.equals("")){
            text_release_details.text = "Release date not available"
        } else {
